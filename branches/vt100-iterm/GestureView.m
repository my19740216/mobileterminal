...
- (void)mouseUp:(struct __GSEvent*)event {
    ...
    if (r > 30.0f) {
        ...
        if (characters) [_shellProcess write: [characters cStringUsingEncoding: NSASCIIStringEncoding] length: [characters lengthOfBytesUsingEncoding: NSASCIIStringEncoding]];
    }
/*
